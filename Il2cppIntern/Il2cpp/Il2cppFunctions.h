...
API_FUNC(intptr_t, il2cpp_resolve_icall, (char* name));
...
API_FUNC(intptr_t, il2cpp_class_from_name, (intptr_t image, char* namespaze, char* name));
...
API_FUNC(intptr_t, il2cpp_class_get_property_from_name, (intptr_t klass, char* name));
API_FUNC(intptr_t, il2cpp_class_get_field_from_name, (intptr_t klass, char* name));
API_FUNC(intptr_t, il2cpp_class_get_methods, (intptr_t klass, intptr_t& iter));
API_FUNC(intptr_t, il2cpp_class_get_method_from_name, (intptr_t klass, char* name, int argsCount));
...
API_FUNC(intptr_t, il2cpp_string_new, (char* str));
API_FUNC(intptr_t, il2cpp_string_new_len, (char* str, int length));
API_FUNC(intptr_t, il2cpp_string_new_utf16, (char* text, int len));
API_FUNC(intptr_t, il2cpp_string_new_wrapper, (char* str));
API_FUNC(intptr_t, il2cpp_string_intern, (char* str));
API_FUNC(intptr_t, il2cpp_string_is_interned, (char* str));
...
API_FUNC(intptr_t, il2cpp_image_get_filename, (intptr_t image));
